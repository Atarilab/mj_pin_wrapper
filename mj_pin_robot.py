...
class MJPinQuadRobotWrapper(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pin: PinQuadRobotWrapper = PinQuadRobotWrapper(
            self.path_urdf, self.path_package_dir, q0=self.mj.q0, **kwargs
        )
    ...
    def _check_models(self) -> None:
        ...
        assert (
            self.pin.nq == self.mj.nq
            and self.pin.nv == self.mj.nv
            and self.pin.nu == self.mj.nu
            and self.pin.ne == self.mj.ne
